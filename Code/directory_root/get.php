...
<body>
    ...
    <div class="response">
    <?php
        if (isset($_GET['club_name']) && isset($_GET['country_name'])) {
            echo "This is your Favorite Team!<br>"; // Line break after "Hello"
            echo "Team: " . htmlspecialchars($_GET['club_name']) . "<br>"; // Prepend "Team" before club_name
            echo "Country: " . htmlspecialchars($_GET['country_name']); // Prepend "Country" before country_name
        } else {
